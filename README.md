...
[![Location](https://img.shields.io/badge/Bangkok-Thailand-0a66c2?style=flat-square)](#)
...
`REST APIs` `SNS/SQS` `S3` `IAM` `MCP server integration`
...
![Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=p1tap&theme=github-compact&hide_border=true&area=true)
